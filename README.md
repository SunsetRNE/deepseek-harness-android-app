...
> ⚠️ 这是源码与配置仓库，**不含 APK 二进制、签名密钥（release.jks）、node 运行时、payload.zip、凭证文件**。构建前需自行准备 DSH 内核与 node 运行时。
...
docs/给下一个AI的交接说明.md   项目交接文档（完整状态与踩坑）
```

## 构建说明

详见 `docs/给下一个AI的交接说明.md` 第七节「常用命令」。
