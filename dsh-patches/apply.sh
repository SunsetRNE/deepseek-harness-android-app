...
# 前端（自研页面）已废弃；移动端适配见 mobile-patch/（由 dshapk/build.sh 打包时注入）。
...
"$NODE" -e '
const fs = require("fs");
const p = "/data/data/com.coomi.android/files/home/dshroot/lib/node_modules/@deepseek-ai/dsh/package.json";
